...
build-1204628737: ../i2c_target_rw_multibyte_fifo_poll.syscfg
	...
	"C:/ti/sysconfig_1.21.0/sysconfig_cli.bat" --script "C:/Users/Mahak/workspace_prac/i2c_target_rw_multibyte_fifo_poll_LP_MSPM0G3507_nortos_ticlang/i2c_target_rw_multibyte_fifo_poll.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_02_00_05/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
